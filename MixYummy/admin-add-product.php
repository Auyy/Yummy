...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
      ...
      $stmt->prepare($sql);
      $params = [0, $_POST['name'], $_POST['detail'], $_POST['price'], $_POST['quality'], $_POST['allergymix'],
      ...
      end_post:             
      echo '<div class="alert $contextual mb-4" role="alert">';
      echo      $msg ;
...
<div class="form-group mt-3">
      <label>ปริมาณ</label>
      <input type="text" name="quality" class="form-control form-control-sm" required>
</div>
<div class="form-group mt-3">
      <label>ส่วนผสมที่อาจจะแพ้</label>
      <input type="text" name="allergymix" class="form-control form-control-sm" required>
</div>
...
for ($i = 1; $i <= 4; $i++) {       //สร้างอินพุท file จำนวน 4 อัน
      ...
      echo  "<input type=\"file\" name=\"upfile[]\" class=\"custom-file-input\" accept=\"image/*\">";
      echo  '<label class="custom-file-label">เลือกไฟล์</label>';
      echo  '</div>';
}
?>
</div>
